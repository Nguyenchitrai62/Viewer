...
const CONFIG = {
    ...
    MANUAL_LABEL_DASH_SEGMENT_MAX_LENGTH: 100, // Do dai toi da cua moi doan line de xem la net dut
    MANUAL_LABEL_DASH_SEGMENT_LENGTH_TOLERANCE_RATIO: 2, // Cho phep doan net dut dai hon muc chuan mot chut o elbow/tee
    MANUAL_LABEL_DASH_MAX_ENDPOINT_GAP: 100, // Khoang cach toi da giua hai doan net dut lien tiep
